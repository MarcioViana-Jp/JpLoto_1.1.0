...
public class PlanAddRequest
{
    ...
    public PlanAddRequest(string planCode, string description, int price, DateTime notBefore, DateTime validThru, int expirationFactor, int expirationDescriptor)
    {
        PlanCode = planCode;
