...
public class PlanResponse
{
    ...
    public PlanResponse(int id, string planCode, string description, int price, DateTime notBefore, DateTime validThru, int expirationFactor, int expirationDescriptor, bool isActive)
    {
        Id = id;
        PlanCode = planCode;
