...
public class PlanUpdateRequest
{
    ...
    public PlanUpdateRequest(int id, string planCode, string description, string colorClass, int price, DateTime notBefore, DateTime validThru, int expirationFactor, int expirationDescriptor, bool isActive)
    {
        Id = id;
        PlanCode = planCode;
