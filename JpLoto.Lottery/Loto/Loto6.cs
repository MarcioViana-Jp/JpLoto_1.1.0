...
public class Loto6 : LotoBase
{
    ...
    public LotoResponse GeraCombinacoes(int quantidadeLimite, bool mantemAnteriores = true, bool combinacoesAleatorias = false)
    {
        ...
        if (quantidadeLimite < 1 || quantidadeLimite > quantidadeLimiteCalculada)
            ...
            {
                Successo = false,
                Mensagem = _lotoLocalizer.Get("Error_InvalidMaxCombinations")
            };
        ...
        if (qtdNiveis == 1)         // Nivel 1: 5 dezenas fixas
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
                ...
                Array.Sort(jogoTemp);
                jogosTemp.Add(VetorParaTexto(jogoTemp, LotoType.Loto6));
            }
        }
        else if (qtdNiveis == 2)    // Nivel 2: 4 dezenas fixas
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
        ...
        else if (qtdNiveis == 3)    // Nivel 3: 3 dezenas fixas
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
                for (int b = a + 1; b <= (QuantidadeDezenasSelecionadas - qtdNiveis + 1); b++)
        ...
        else if (qtdNiveis == 4)    // Nivel 4: 2 dezenas fixas
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
                for (int b = a + 1; b <= (QuantidadeDezenasSelecionadas - qtdNiveis + 1); b++)
        ...
        else if (qtdNiveis == 5)    // Nivel 5: 1 dezena fixa
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
                for (int b = a + 1; b <= (QuantidadeDezenasSelecionadas - qtdNiveis + 1); b++)
        ...
        else    // Nivel 6: nenhuma dezena fixa
        {
            for (int a = 0; a <= (QuantidadeDezenasSelecionadas - qtdNiveis); a++)
            {
                for (int b = a + 1; b <= (QuantidadeDezenasSelecionadas - qtdNiveis + 1); b++)
